...
role :web, "autismapp.com"                          # Your HTTP server, Apache/etc
role :app, "autismapp.com"                         # This may be the same as your `Web` server
role :db,  "autismapp.com"   , :primary => true # This is where Rails migrations will run
